...
export function LoginForm({ className, ...props }: LoginFormProps) {
    ...
    const loadingIcon = <FontAwesomeIcon icon={faCompactDisc} size="xl" spin />;
    return (
        <>
            ...
            <div className={cn('grid gap-6 text-black', className)} {...props}>
                ...
                <Button variant="outline" type="button" disabled={isLoading}>
                    {isLoading ? (
                        ...
                        <div className="mr-2">{githubIcon}</div> //git login icon
                    )}
                    GitHub
                </Button>
            </div>
